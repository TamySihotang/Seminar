...
/**
 * CostAccumulationSearch represents the model behind the search form about `common\models\CostAccumulation`.
 */
class CostAccumulationSearch extends CostAccumulation
{
    ...
    {
        return [
            [['id_accumulation', 'user_id', 'paper_id', 'cost_id'], 'integer'],
    ...
    public function search($params)
    {
        ...
        $query->andFilterWhere([
            'id_accumulation' => $this->id_accumulation,
